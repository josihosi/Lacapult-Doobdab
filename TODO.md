...
7. Park next slices
   - Full in-launcher install pass for the selected macOS DMG, including real extraction into Lacapult install folders and optional launch smoke, only when Schani/Josef wants that heavier proof; the sandboxed copy/move shape is already proven.
   - OpenVINO full setup.
