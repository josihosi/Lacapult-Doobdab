...
7. Park next slices
   ...
   - [queued] Lacapult post-mod UI Windows retest release packet: the mod/Summarizer UI lane is now honestly retestable, so the next step is to regenerate/publish a fresh Lacapult GitHub test/prerelease only after Schani/Josef explicitly greenlights that external release publication. Canonical contract: `doc/lacapult-post-mod-ui-windows-retest-release-packet-2026-04-26.md`.
