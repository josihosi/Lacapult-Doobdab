...
7. Park next slices
   ...
   - [active] Real C-AOL mod/Summarizer generation/apply UI v0: Settings apply-preview, confirmed writer/apply seam, and first backend-generation seam are landed and sandbox-smoked; next bounded step is UI/error polish and optional real-local Ollama generation smoke behind the same confirmation/readiness gates, still without secrets, model pulls, package installs, or real Application Support mutation in automated proof.
