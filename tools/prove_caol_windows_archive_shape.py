...
REQUIRED_FILES = (
	...
	"tools/openclaw_harness/scenarios/manual.cannibal_night_pack_mcw.json",
	"tools/openclaw_harness/scenarios/manual.intact_camp_shakedown_mcw.json",
	"tools/openclaw_harness/scenarios/manual.mixed_hostile_siege_mcw.json",
	"tools/openclaw_harness/scenarios/manual.writhing_stalker_hit_fade_mcw.json",
	"tools/openclaw_harness/scenarios/manual.zombie_rider_open_field_mcw.json",
	"zzip.exe",
	"README.md",
	"TechnicalTome.md",
	"VERSION.txt",
