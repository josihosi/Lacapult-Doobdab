...
0. Lacapult launcher hotfix prerelease — published for Josef Windows test
   ...
   - [ ] Josef Windows laptop click-through/playtest remains external: download/extract/run the unsigned Windows zip, then test C-AOL install/play/resume/settings/mod status/backups.

0. Lacapult post-mod UI Windows retest prerelease — published for Josef Windows test
   - [x] Josef explicitly greenlit the queued external release publication (`yes release pls`).
   - [x] Regenerated fresh unsigned Lacapult package artifacts from current `main` / source commit `8c9d8f3d5e3bc9757fffd69b7eeecd8cb8bcbdba` with the Windows `utils/7za.exe` sidecar preserved.
   - [x] Published GitHub prerelease `lacapult-post-mod-ui-retest-2026-04-26`: https://github.com/josihosi/Lacapult-Doobdab/releases/tag/lacapult-post-mod-ui-retest-2026-04-26
   - [x] Verified the remote release/assets with `gh release view`; Windows zip is `66,479,179` bytes, SHA-256 `694823044d89f091257ce6dedbf3cd92d0ba3b13ba0014ee3264146dae29dc42`.
   - [x] Release notes say this is an unsigned Lacapult launcher retest build for the UI/mod-installer lane, not a C-AOL game release, not C-AOL `v0.3.0`, and not public-final signed confidence.
   - [ ] Josef Windows laptop click-through/playtest remains external: download/extract/run the unsigned Windows zip, then test C-AOL install/play/resume/settings/mod status/Summarizer preview+confirm/backups.
...
7. Park next slices
   ...
   - [x] Lacapult post-mod UI Windows retest release packet: Josef greenlit the external publication and the fresh GitHub test/prerelease is published at https://github.com/josihosi/Lacapult-Doobdab/releases/tag/lacapult-post-mod-ui-retest-2026-04-26. Canonical contract: `doc/lacapult-post-mod-ui-windows-retest-release-packet-2026-04-26.md`. Josef's Windows laptop click-through/playtest remains external.
