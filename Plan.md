...
**Status:** CLICKED INSTALL + BACKEND TRIAD + MOD/SUMMARIZER BRIDGE UI STATUS + LOCAL UNSIGNED APP/PACKAGE EXPORTS PROVEN + LAUNCH PREFLIGHT STATUS PROVEN / GAME-LAUNCH SMOKE BLOCKED BY C-AOL macOS DYLIBS / SIGNING+PUBLIC RELEASE NOT CLAIMED
