...
0. Lacapult LLM backend setup installer packet v0 — active / greenlit
   - [ ] Move backend setup out of generic Settings into its own tab/page titled exactly `C-AOL LLM backend setup`.
