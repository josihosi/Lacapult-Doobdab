...
print("  real setup path status says venv, harness requirements, and AnyLLM packages were handled")
print("  failure path says venv/harness/package setup failed without API/secret use and surfaces captured package output")
