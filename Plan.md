...
**Status:** LACAPULT LLM BACKEND SETUP INSTALLER PACKET SCHANI-REVIEWED / HOTFIX PRERELEASE PUBLISHED / POST-MOD UI RETEST PRERELEASE PUBLISHED / C-AOL v0.2.0 INSTALL+LAUNCH REPAIR PROVEN / C-AOL v0.3 RELEASE PARKED
