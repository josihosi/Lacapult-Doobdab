...
def main() -> None:
    ...
    require("create_or_update_venv" in backend_config and "install_openclaw_harness_requirements" in backend_config and "install_anyllm_packages" in backend_config, "API setup plan lacks venv/harness/package phases")
    ...
    require("Downloadable add-on mods" in mods_ui and "Magiclysm/DinoMod JSON catalog targets were not found" in mods_ui, "C-AOL downloadable empty-state is not explicit")
    ...
    print("  API setup has venv + harness requirements + AnyLLM phases and proof-safe intent shape")
