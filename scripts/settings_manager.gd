...
const _HARDCODED_DEFAULTS = {
	...
	"backend_external_setup_proof_only": false,
	"backend_runner_test_proof_only": false,
	"backend_api_runner_test_status": "",
	"backend_ollama_runner_test_status": "",
	"backend_ollama_endpoint": "http://127.0.0.1:11434",
	"backend_ollama_model": "",
	"backend_openvino_model_dir": "",
	"backend_openvino_device": "AUTO",
